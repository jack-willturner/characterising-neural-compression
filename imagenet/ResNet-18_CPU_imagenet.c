...
int im_sizes[20] = { 224, 112, 56,  56,  56,  28,  28,  28,  28,  28,  14, 14, 14, 14, 14, 7,  7,  7,  7,  7};
//int im_sizes[20] = { 224, 224, 224, 224, 224, 112, 112, 112, 112, 56, 56, 56, 56, 56, 28, 28, 28, 28, 28 };
...
void get_resnet18_predict(FILE *out, int only_convolution) {
  ...
  */
  ...
  // average pool 7 with 1024 channels of 7x7 images
	avg_pool(mem_block1, mem_block2, 512, 7, 7);

	// flatten
	flatten(mem_block2, mem_block1_dense, cshape[level][0], 1, 1);
